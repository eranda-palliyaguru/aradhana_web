...
මෙම TOKEN අයදුම්කල හැක්කේ සෞඛ්‍යය කාර්ය මණ්ඩලයට පමනි. කරුණාකර වෙනත් පාර්ශවයන් අයදුම් කිරීමෙන් වැලකී සිටින්න.
<br>
This TOKEN can only be applied to health staff.  Please refrain from applying other parties.
</div></div>
...
ඔබේ අයදුම්පත තහවුරු කිරීමේ ක්‍රියාවලියෙන් පසු TOKEN පත වලංගු වන බව කරුණාවෙන් සලකන්න. 
<br>Please note that the TOKEN will be valid after the verification process of your application.
</div></div>
</div>
